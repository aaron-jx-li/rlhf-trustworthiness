...
def main():
    ...
    #device = "cuda:0" if torch.cuda.is_available() else "cpu"
    tokenizer_names = [#"EleutherAI/pythia-70m", "EleutherAI/pythia-160m", 
    ...
    model_names = [ #"EleutherAI/pythia-70m", "EleutherAI/pythia-160m", 
                    #"EleutherAI/pythia-410m",
                    #"EleutherAI/pythia-2.8b", 
                    #"skrishna/eleuther-pythia70m-hh-dpo",
                    #"skrishna/eleuther-pythia160m-hh-dpo",
    ...
    for m in range(len(model_names)):
        ...
        tokenizer = AutoTokenizer.from_pretrained(tokenizer_name, cache_dir="/n/holyscratch01/hlakkaraju_lab/Lab/aaronli/models")
